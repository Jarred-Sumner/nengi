...
nengi.Basic = nengi.Protocol = Protocol;

nengi.Entity = nengi.EntityProtocol = EntityProtocol;

nengi.LEvent = nengi.LocalEventProtocol = LocalEventProtocol;

nengi.Msg = nengi.Message = nengi.MessageProtocol = MessageProtocol;

nengi.Command = nengi.CommandProtocol = CommandProtocol;
